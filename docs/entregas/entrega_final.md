...
|   <img src="../../planejamento/img/logos/logo_lucidchart.png" alt="LucidChart" width="80"/>   |  LucidChart <a id="c" href="#cc">[3]</a> | O Lucidchart é uma aplicação web para diagramação. <a id="l" href="#ll">[12]</a> | Usado para criar os Rich Pictures dos aplicativos analisados e o escolhido para estudo, além de outros diagramas, como por exemplo, os SIG's do NFR Framework. | [1: Planejamento (Pré-rastreabilidade)](../pre_rastreabilidade/lista_de_aplicativos.md) </br> [4: Modelagem](../modelagem/nfr_framework.md) |
|   <img src="../../planejamento/img/logos/logo_mkdocs.png" alt="MkDocs" width="80"/>   |  MkDocs <a id="d" href="#dd">[4]</a> | MkDocs é um gerador de sites estáticos, rápido e simples, voltado para a construção de documentação de projetos. <a id="d" href="#dd">[4]</a> | Usado para criar a GitPage. | [1: Planejamento](../index.md) |
...
| `1.2`  |    05/12/2023    |   06/12/2023    |   Seção de Ferramentas    | [Ana Caroline](https://github.com/anaaroch_)  |  |
| `1.3`  |    dd/mm/aaaa    |   dd/mm/aaaa    |   Descrição do que foi feito    | Nome do Autor |  |

### Verificação

| Data de Revisão | Cobertura de Versões  |          Técnica         |     Revisor(es)    |
| :------------: | :-------------: | :--------------------------: |  :---------------: |
<!-- |   dd/mm/aaaa   |    `1.0`   |    [Elaboração em pares](../../planejamento/verificacao/revisoes.md)      |  Nome do Revisor | -->