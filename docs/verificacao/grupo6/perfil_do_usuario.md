# Verificação do artefato ["Perfil do Usuário"](https://requisitos-de-software.github.io/2023.2-Skoob/planejamento/perfil_do_usuario/)
...
Neste contexto, pretendemos aplicar essa técnica ao artefato ["Perfil do Usuário"](https://requisitos-de-software.github.io/2023.2-Skoob/planejamento/perfil_do_usuario/) desenvolvido pelo [Grupo 6](https://requisitos-de-software.github.io/2023.2-Skoob/).<a id="a" href="#aa">[3]</a>. A verificação é baseada no plano de ensino e nas datas estabelecidas nele.
...
Espera-se que o artefato explique a técnica para definir o perfil de usuário e apresente o resultado.
...
| 5   | Todas as referências foram citadas no texto?                          | Não        | Pode melhorar      | Nenhuma foi citada.                                       |
...
| 3   | Apresente o termo de consentimento?                                                             | Sim        | Ótimo         |                                                        |
| 4   | O questionário coleta dados úteis para o levantamento do perfil?                                | Sim        | Bom           | Seria interessante perguntar se o usuário é estudante, empregado... etc. Esse dado poderia ajudar ainda mais a entender qual é o público que utiliza o Skoob |

<b>Tabela 2</b>: Perguntas selecionadas: Conteúdo do artefato. (Fonte: Rafael Amancio, 2023)

## Correções e ajustes sugeridos

O artefato foi muito bem elaborado e seguiu todos os checklists apresentados na tabela. O questionário elaborado pela equipe poderia ter algumas perguntas mais relevantes para complementar o perfil de usuário.
