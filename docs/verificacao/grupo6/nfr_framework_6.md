...
| 5   | As tabelas e imagens possuem legenda, fonte e são introduzidas no texto?    |  |  |  |
| 6   | As referências bibliográficas estão citadas no texto?                         |  |  |  |
| 6   | Todas informações que o texto trás, citam e são referenciadas com alguma bibliografia?  |  |  |  | 
| 7   | Existe uma metodologia definida no artefato?                 |  |  |  |
| 8   | Esá descrita a definição do RNF?                             |  |  |  |
| 9   | Existe o cartão de especificação do RNF?                     |  |  |  |
| 10  | Os softgoals condizem com o contexto?                        |  |  |  |
| 11  | Softgoals representam metas bem definidas?                   |  |  |  |
