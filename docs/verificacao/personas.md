# Verificação do artefato ["Personas"](https://requisitos-de-software.github.io/2023.2-DETRAN/Entrega_2/personas/)
...
| 8   | As personas apresentam imagens de pessoas fictícias e padronizadas?                   | Sim        | Bom         |   As imagens das personas estão muito grande, fazendo com que perde um pouco a atenção das características e descrições                           |
